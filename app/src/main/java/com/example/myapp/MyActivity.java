...
public class MyActivity extends Activity {
    ...
    private String[] activities = new String[]{"RListActivity", "TestActivityActivity", "MyWheelActivity", "WebViewActivity", "SlideActivity", "PagerActivity", "FragmentTestActivity","CoordsTestActivity", "FocusTestActivity", "LitepalActivity", "ServiceActivity", "AActivity", "HtmlActivity",  "ParcelableActivity", "ShakeActivity",
            "TextPushActivity",
            "TestViewActivity",
            "FocusActivity",
            "WindowActivity",
